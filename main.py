...
class CameraBox(BoxLayout):
    def __init__(self, **kwargs):
        ...
        # LOAD RICE TYPES FROM DATASET FOLDER
        ...
        for rice_class in self.rice_classes:
            ...
            sample_image_path = os.path.join(class_path, os.listdir(class_path)[0])  # Load the first image as a sample
    ...
    def capture_image(self, instance):
        def process_image():
            ...
            if highest_similarity > confidence_threshold:
                ...
                self.result_label.text = "Captured image does not match sample rice images."
